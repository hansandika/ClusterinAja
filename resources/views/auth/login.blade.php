            ...
            <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    ...
                    <a href="{{ route('provider-login', 'google') }}"
                        class="flex items-center justify-center w-full px-6 py-3 mt-4 font-semibold text-gray-900 bg-white border-2 border-gray-500 rounded-md shadow outline-none hover:bg-blue-50 hover:border-blue-400 focus:outline-none"><svg
