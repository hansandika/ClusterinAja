                ...
                <div class="container max-w-sm px-4 py-8 mx-auto space-y-6 md:px-0 md:pt-12 md:max-w-lg">
                    ...
                    <div class="space-y-2 ">
                        ...
                        <div class="relative">
                            ...
                            <input datepicker datepicker-autohide type="text" id="dob" name="dob" autocomplete="dob"
                                required
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPEG, JPG or
                            GIF
                        </p>
                        @error('image')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                    ...
                    <div>
                        <label for="biography"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Biography</label>
